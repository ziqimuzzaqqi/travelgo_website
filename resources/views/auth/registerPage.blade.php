...
<body class="register-page bg-body-secondary">
    <div class="register-box">
        <div class="register-logo"> <a href="{{route('register')}}"><b>Travel</b>GO</a> </div> <!-- /.register-logo -->
        <div class="card">
            <div class="card-body register-card-body">
                <p class="register-box-msg">Buat Akun dan Mulailah Perjalanan</p>
                <form action="{{route('register.proses')}}" method="post">
                    @csrf
                    @error('name')
                        <span class="text-danger small ms-2">{{ $message }}</span>
                    @enderror
                    <div class="input-group mb-3"> <input type="text" class="form-control" placeholder="Nama Lengkap" name="name">
                ...
                <p class="text-center"> <a href="{{route('login')}}" class="text-center">
                        Sudah Punya Akun?
                    </a> </p>
